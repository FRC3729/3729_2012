...
\begin{center}
\leavevmode
\includegraphics[width=363pt]{_teleoperated_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=321pt]{_teleoperated_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
\begin{DoxyCompactItemize}
\item 
class \hyperlink{class_r_j_f_r_c2011_1_1_teleoperated}{Teleoperated}
